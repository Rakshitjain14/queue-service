...
public class RedisQService implements PQService {

    private final Jedis jedis;
    private Integer visibilityTimeout;
    private final Logger logger = LogManager.getLogger(RedisQService.class);
    private final Gson gson = new GsonBuilder().serializeNulls().create();

    public RedisQService() {
    ...
    public void push(String queueUrl, String msgBody, int rank) {
        Long now = now();
        PQMessage priorityMessage = new PQMessage(rank, now, new Message(msgBody));
        try {
    ...
    public Message pull(String queueUrl) {
        ...
        try {
            ...
            for (Tuple tuple : tuples) {
                ...
                PQMessage priorityMessage = gson.fromJson(deserializedMessage, PQMessage.class);
    ...
    public void delete(String queueUrl, String receiptId) {
        try {
            ...
            for (String member : members) {
                logger.info(member);
                PQMessage priorityMessage = gson.fromJson(member, PQMessage.class);
    ...
    private double score(PQMessage priorityMessage) {
    ...
    public static void main(String[] args) {
        RedisQService redisQueueService = new RedisQService();
